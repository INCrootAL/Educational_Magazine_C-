...
namespace ottb
{
    public partial class Jurnal4s : Form
    {
        public Jurnal4s()
        {
            InitializeComponent();
        ...
        private void Jurnal4s_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void Jurnal4s_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (ifcon) con.Close();
        }
        ...
        private void Control()
        {
            ...
            SqlCom1.CommandText = "SELECT DISTINCT IDработника, Работник, IDподразделения2 FROM Журнал4";
